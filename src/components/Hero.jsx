  ...
  return (
    <section className = "min-h-screen flex flex-col justify-start items-center p-5 text-center">
        ...
        <p className = "max-w-xl font-light text-gray-500"> 
            ...
            my name is Ashley Grant. I am recent college graduate with a undergrad degree in Computer Science and masters degree in Management of Information Systems. <br/><br/> ⭐️ ⭐️ ⭐️ ⭐️ ⭐️<br/><br/>
            During my undergrad and graduate studies I was an Undergrad Teaching Assistant for
            <ul>
              <li> Introduction to Computer Science 1 </li>
              <li> Introduction to Computer Science 2 </li>
              <li> Web Applications </li>
            </ul>
            <br/> <br/> ⭐️ ⭐️ ⭐️ ⭐️ ⭐️<br/><br/>
